...
//                }
        ...
        $scope.toggleFavoriteChannel = function () {
            if(currentChannelIndex != undefined) { //check to see if a channel is playing
                if(true) { //if a channel is playing
                    console.log('this channel is playing ' + currentChannelIndex);
