(function (app){
    'use strict';
    console.log('blah')
    app.controller('epgCtrl', ['$scope', '$rootScope', 'mediaSvc', '$filter', '$cookies', 'epgSrvc', '$location', '$anchorScroll', '$timeout', '$window', function ($scope, $rootScope, mediaSvc, $filter, $cookies, epgSrvc, $location, $anchorScroll, $timeout, $window){
        console.log('epg controller loaded')
        ...
        function activate(){
            ...
            $rootScope.$on('ChannelsLoaded', function () {
                epgSrvc.getProgramming(function(err, programming){
                    ...
                    console.log('$scope.programming stuffs', $scope.programming[0], $scope.programming[$scope.programming.length - 1], $rootScope.channels[$scope.nextIndex].id, $rootScope.channels[$scope.prevIndex].id)
