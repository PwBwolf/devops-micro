(function (app) {
    ...
    app.config(['$translateProvider', function ($translateProvider) {
        $translateProvider.translations('en', {
            ...
            FREE_SIGN_UP_SUCCESS_LINE2_PART1: 'Please verify your account by clicking the link in the email we sent you or click',
            FREE_SIGN_UP_SUCCESS_LINE2_PART2: 'HERE',
            FREE_SIGN_UP_SUCCESS_LINE2_PART3: 'to enter the PIN we sent you by text message.',
            ...
            RESEND_VERIFICATION_SUCCESS_MESSAGE: 'Email and text message to verify your account have been sent. To enter PIN received on text message click',
            RESEND_VERIFICATION_SUCCESS_HERE: 'here',
            ...
            SIGN_UP_SUCCESS_LINE2_PART1: 'Please verify your account by clicking the link in the email we sent you or click',
            SIGN_UP_SUCCESS_LINE2_PART2: 'HERE',
            SIGN_UP_SUCCESS_LINE2_PART3: 'to enter the PIN we sent you by text message.',
            ...
            SIGN_UP_SUCCESS_PAYMENT_FAILURE_LINE1_PART1: 'We had a problem processing your credit card information. The good news is that you are now a <span class="bolder-text">Free Member</span> and you can start watching live TV for FREE once you click on the link in the verification email we sent you or enter the PIN we sent you by text message',
            SIGN_UP_SUCCESS_PAYMENT_FAILURE_LINE1_PART2: 'HERE',
            ...
            SIGN_UP_SUCCESS_PAYMENT_FAILURE_BULLET1_PART1: 'Click the verification link in the email we just sent you or enter the PIN we sent by text message',
            SIGN_UP_SUCCESS_PAYMENT_FAILURE_BULLET1_PART2: 'HERE',
