(function (app) {
    ...
    app.config(['$translateProvider', function ($translateProvider) {
        $translateProvider.translations('en', {
            ...
            RESEND_VERIFICATION_SUCCESS_MESSAGE: 'Email and text message to verify your account have been sent. To enter PIN received by text message click button below',
