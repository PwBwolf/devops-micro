(function (app) {
    ...
    app.config(['$translateProvider', function ($translateProvider) {
        $translateProvider.translations('en', {
            ...
            FREE_SIGN_UP_MESSAGE: 'No trail periods, no catches, just FREE TV!',
            ...
            FREE_SIGN_UP_SUCCESS_BULLET4: 'Keep your <span class="bolder-text">FREE Membership</span> as long as you like or upgrade and get 90+ channels - its up to you!',
            ...
            MOBILE_VERIFICATION_HEADING: 'Verify Account',
            MOBILE_VERIFICATION_PIN: 'Enter PIN received by text message',
            MOBILE_VERIFICATION_PIN_REQUIRED: 'Enter your PIN',
            MOBILE_VERIFICATION_PIN_INVALID: 'Enter a valid PIN',
            ...
            RESEND_VERIFICATION_HEADING: 'Resend Verification Email and Text Message',
            RESEND_VERIFICATION_EMAIL: 'Enter your email',
            RESEND_VERIFICATION_EMAIL_INVALID: 'Enter a valid email address',
            RESEND_VERIFICATION_EMAIL_REQUIRED: 'Enter your email address',
            RESEND_VERIFICATION_SEND_SMS_VERIFICATION: 'Send verification via text message<sup>*</sup>',
            ...
            RESEND_VERIFICATION_SUCCESS_HEADING: 'Resend Verification Email and Text Message',
            RESEND_VERIFICATION_SUCCESS_MESSAGE: 'Email and/or text message to verify your account have been sent. To enter PIN received by text message click button below',
            RESEND_VERIFICATION_SUCCESS_BUTTON: 'Enter PIN',
            ...
            SIGN_IN_NO_VERIFICATION_EMAIL: 'Did not receive verification email / text message?',
            ...
            SIGN_UP_BULLET1: '90+ live international <span style="text-decoration: underline">channels</span>',
            ...
            SIGN_UP_SUCCESS_BULLET1: '90+ FREE Live International Channels',
            ...
            SIGN_UP_SUCCESS_LOGIN_BULLET1: '90+ FREE Live International Channels',
            ...
            SIGN_UP_VERIFICATION_PIN: 'Enter PIN received by text message',
            ...
            SIGN_UP_VERIFICATION_SUB_HEADING: 'You can verify your account either by entering the PIN we texted you or by clicking the link in the verification email we just sent you.',
            SIGN_UP_VERIFICATION_SMS_RESEND: 'Resend verification text message',
            SIGN_UP_VERIFICATION_EMAIL_RESEND: 'Resend verification email',
            SIGN_UP_VERIFICATION_PIN_MISMATCH: 'PIN entered is incorrect. Please enter the PIN we texted to your mobile number',
            SIGN_UP_VERIFICATION_ERROR: 'Unable to verify account. Please contact customer support at',
            SIGN_UP_VERIFICATION_SMS_RESEND_SUCCESS: 'Verification text message has been resent to your mobile',
            SIGN_UP_VERIFICATION_EMAIL_RESEND_SUCCESS: 'Verification email has been resent to your email address',
