(function (app) {
    ...
    app.config(['$translateProvider', function ($translateProvider) {
        $translateProvider.translations('en', {
            ...
            SIGN_UP_VERIFICATION: 'Verification PIN will be sent via text message<sup>*</sup> if mobile number is entered else by email.',
            ...
            SIGN_UP_EMAIL_SMS_SUBSCRIPTION: 'Please send me updates (via text message<sup>*</sup> if mobile number is entered else by email)',
