(function (app) {
    ...
    app.factory('networksSvc', [function () {
        var networks = [
            ...
            {networkName: 'beIN SPORTS en Español', networkId: 'images/channels-small/bein-sports-espanol.png', networkImage: 'images/channels-big/bein-sports-espanol.png', networkAlt: 'NETWORKS_BEIN_SPORTS_ES', networkDescription1: 'NETWORKS_BEIN_SPORTS_ES_DESC', networkDescription2: 'NETWORKS_BEIN_SPORTS_ES_DESC_1', networkDescription3: 'NETWORKS_BEIN_SPORTS_ES_DESC_2'},
            ...
            {networkName: 'NTN24', networkId: 'images/channels-small/ntn-24.png', networkImage: 'images/channels-big/ntn-24.png', networkAlt: '', networkDescription1: 'NETWORKS_NTN_24_DESC', networkDescription2: 'NETWORKS_NTN_24_DESC_1', networkDescription3: 'NETWORKS_NTN_24_DESC_2'},
            ...
            {networkName: 'Destinos TV', networkId: 'images/channels-small/destino.png', networkImage: 'images/channels-big/destino.png', networkAlt: '', networkDescription1: 'NETWORKS_DESTINOS_TV_DESC', networkDescription2: 'NETWORKS_DESTINOS_TV_DESC_1', networkDescription3: 'NETWORKS_DESTINOS_TV_DESC_2'},
