(function (app) {
    ...
    app.factory('footerSvc', [function () {
        ...
        var general_Ctgry = [
            ...
            {channelName: 'Canal America', channelCtgry: '2', showTitle: 'SHOWS_ENT_PNL_2_TITLE', showDescription: 'FOOTER_CHANNEL_GNRL_2', showDescriptionContent: 'SHOWS_ENT_PNL_2_DESC_CNTNT'},
        ...
        var music_Ctgry = [
            ...
            {channelName: 'Mi Gente TV', channelCtgry: '4', showTitle: 'SHOWS_ENT_PNL_4_TITLE', showDescription: 'FOOTER_CHANNEL_MSC_4', showDescriptionContent: 'SHOWS_ENT_PNL_4_DESC_CNTNT'},
            {channelName: 'Mi Musica', channelCtgry: '5', showTitle: 'SHOWS_ENT_PNL_5_TITLE', showDescription: 'FOOTER_CHANNEL_MSC_5', showDescriptionContent: 'SHOWS_ENT_PNL_5_DESC_CNTNT'},
            {channelName: 'Video Rola', channelCtgry: '6', showTitle: 'SHOWS_ENT_PNL_6_TITLE', showDescription: 'FOOTER_CHANNEL_MSC_6', showDescriptionContent: 'SHOWS_ENT_PNL_6_DESC_CNTNT'},
			{channelName: 'JCTV', channelCtgry: '7', showTitle: 'SHOWS_ENT_PNL_6_TITLE', showDescription: 'FOOTER_CHANNEL_MSC_7', showDescriptionContent: 'SHOWS_ENT_PNL_6_DESC_CNTNT'}
        ];
        ...
        var ent_Ctgry = [
            ...
            {channelName: 'Canal 52 MX', channelCtgry: '4', showTitle: 'SHOWS_ENT_PNL_5_TITLE', showDescription: 'FOOTER_CHANNEL_ENT_4', showDescriptionContent: 'SHOWS_ENT_PNL_5_DESC_CNTNT'},
            {channelName: 'TVC Latino', channelCtgry: '5', showTitle: 'SHOWS_ENT_PNL_6_TITLE', showDescription: 'FOOTER_CHANNEL_ENT_5', showDescriptionContent: 'SHOWS_ENT_PNL_6_DESC_CNTNT'},
			{channelName: 'TV Quisqueya', channelCtgry: '6', showTitle: 'SHOWS_ENT_PNL_6_TITLE', showDescription: 'FOOTER_CHANNEL_ENT_6', showDescriptionContent: 'SHOWS_ENT_PNL_6_DESC_CNTNT'},
			{channelName: 'Tempo', channelCtgry: '7', showTitle: 'SHOWS_ENT_PNL_6_TITLE', showDescription: 'FOOTER_CHANNEL_ENT_7', showDescriptionContent: 'SHOWS_ENT_PNL_6_DESC_CNTNT'},
			{channelName: 'A 3 Series', channelCtgry: '8', showTitle: 'SHOWS_ENT_PNL_6_TITLE', showDescription: 'FOOTER_CHANNEL_ENT_8', showDescriptionContent: 'SHOWS_ENT_PNL_6_DESC_CNTNT'},
			{channelName: 'Teleformula', channelCtgry: '9', showTitle: 'SHOWS_ENT_PNL_6_TITLE', showDescription: 'FOOTER_CHANNEL_ENT_9', showDescriptionContent: 'SHOWS_ENT_PNL_6_DESC_CNTNT'},
			{channelName: 'Tele Pacifico', channelCtgry: '10', showTitle: 'SHOWS_ENT_PNL_6_TITLE', showDescription: 'FOOTER_CHANNEL_ENT_10', showDescriptionContent: 'SHOWS_ENT_PNL_6_DESC_CNTNT'},
			{channelName: 'Tele Medellin', channelCtgry: '11', showTitle: 'SHOWS_ENT_PNL_6_TITLE', showDescription: 'FOOTER_CHANNEL_ENT_11', showDescriptionContent: 'SHOWS_ENT_PNL_6_DESC_CNTNT'},
			{channelName: 'Tele Caribe', channelCtgry: '12', showTitle: 'SHOWS_ENT_PNL_6_TITLE', showDescription: 'FOOTER_CHANNEL_ENT_12', showDescriptionContent: 'SHOWS_ENT_PNL_6_DESC_CNTNT'},
			{channelName: 'Tele Antioquia', channelCtgry: '13', showTitle: 'SHOWS_ENT_PNL_6_TITLE', showDescription: 'FOOTER_CHANNEL_ENT_13', showDescriptionContent: 'SHOWS_ENT_PNL_6_DESC_CNTNT'},
			{channelName: 'JBN', channelCtgry: '14', showTitle: 'SHOWS_ENT_PNL_6_TITLE', showDescription: 'FOOTER_CHANNEL_ENT_14', showDescriptionContent: 'SHOWS_ENT_PNL_6_DESC_CNTNT'},
			{channelName: 'HITN', channelCtgry: '15', showTitle: 'SHOWS_ENT_PNL_6_TITLE', showDescription: 'FOOTER_CHANNEL_ENT_15', showDescriptionContent: 'SHOWS_ENT_PNL_6_DESC_CNTNT'},
			{channelName: 'Cosmovision', channelCtgry: '16', showTitle: 'SHOWS_ENT_PNL_6_TITLE', showDescription: 'FOOTER_CHANNEL_ENT_16', showDescriptionContent: 'SHOWS_ENT_PNL_6_DESC_CNTNT'},
			{channelName: 'Canal Tro', channelCtgry: '17', showTitle: 'SHOWS_ENT_PNL_6_TITLE', showDescription: 'FOOTER_CHANNEL_ENT_17', showDescriptionContent: 'SHOWS_ENT_PNL_6_DESC_CNTNT'},
			{channelName: 'Canal Sur', channelCtgry: '18', showTitle: 'SHOWS_ENT_PNL_6_TITLE', showDescription: 'FOOTER_CHANNEL_ENT_18', showDescriptionContent: 'SHOWS_ENT_PNL_6_DESC_CNTNT'},
			{channelName: 'Canal Antiestres', channelCtgry: '19', showTitle: 'SHOWS_ENT_PNL_6_TITLE', showDescription: 'FOOTER_CHANNEL_ENT_19', showDescriptionContent: 'SHOWS_ENT_PNL_6_DESC_CNTNT'},
			{channelName: 'Antenna3', channelCtgry: '20', showTitle: 'SHOWS_ENT_PNL_6_TITLE', showDescription: 'FOOTER_CHANNEL_ENT_20', showDescriptionContent: 'SHOWS_ENT_PNL_6_DESC_CNTNT'},
			{channelName: 'AZ Corazon', channelCtgry: '21', showTitle: 'SHOWS_ENT_PNL_6_TITLE', showDescription: 'FOOTER_CHANNEL_ENT_21', showDescriptionContent: 'SHOWS_ENT_PNL_6_DESC_CNTNT'},
			{channelName: 'Telemicro Internacional', channelCtgry: '22', showTitle: 'SHOWS_ENT_PNL_6_TITLE', showDescription: 'FOOTER_CHANNEL_ENT_22', showDescriptionContent: 'SHOWS_ENT_PNL_6_DESC_CNTNT'}
