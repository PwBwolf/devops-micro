(function (app) {
    ...
    app.config(['$translateProvider', function ($translateProvider) {
        $translateProvider.translations('en', {
            ...
            FREE_SIGN_UP_SUCCESS_HEADING: 'Thank you for signing up for a Free YipTV 7 day trial account!',
            FREE_SIGN_UP_SUCCESS_MESSAGE_1: 'Please check your email and click on the link to verify your account.',
            FREE_SIGN_UP_SUCCESS_MESSAGE_2: 'You now have access to view a few of our channels. Once you see the amazing quality of YipTV, upgrade to a full account for only $14.99/mo and you will have instant access to 60+ international channels!',
            FREE_SIGN_UP_SUCCESS_MESSAGE_3: 'Next Steps:',
            FREE_SIGN_UP_SUCCESS_MESSAGE_4: 'Be sure to validate your account by clicking the link in the email we sent you.',
            FREE_SIGN_UP_SUCCESS_MESSAGE_5: 'If you will be viewing from your web browser, you can log-in and start watching here:',
            FREE_SIGN_UP_SUCCESS_MESSAGE_6: 'sign in',
            FREE_SIGN_UP_SUCCESS_MESSAGE_7: 'Download our free app and start watching live TV on your mobile device:',
            FREE_SIGN_UP_SUCCESS_MESSAGE_8: 'When you\'re ready to Upgrade',
            FREE_SIGN_UP_SUCCESS_MESSAGE_9: 'Click the “Account” link at the top of the account page, then click the “Upgrade Subscription” button and complete the registration form using a valid credit card. Once you become a customer, you can enjoy all of our channels from your phone, tablet or with our Free TV app or on your PC or Internet-connected TV using any browser.',
            ...
            SIGN_UP_SUCCESS_PAYMENT_FAILURE_HEADING: 'Congrats!',
            ...
            SIGN_UP_SUCCESS_PAYMENT_FAILURE_ACTIVE_HEADING: 'Congrats!',
