(function (app) {
    ...
    app.config(['$translateProvider', function ($translateProvider) {
        $translateProvider.translations('en', {
            ...
            IDT_SIGN_UP_EXPIRY_DATE: 'Expiration Date (MM/YYYY)',
            ...
            IDT_SIGN_UP_SUCCESS_HEADING: 'Congrats!',
            IDT_SIGN_UP_SUCCESS_MESSAGE: 'You are successfully signed up with YipTV. Please click the button or link in the email we have just sent you to verify your account.',
            IDT_SIGN_UP_SUCCESS_LOGIN_HEADING: 'Congrats!',
            IDT_SIGN_UP_SUCCESS_LOGIN_MESSAGE: 'You have successfully signed up with YipTV. <a class="underline-text" href="/sign-in">Sign In</a> to YipTV now.',
            IDT_SIGN_UP_SUCCESS_PAYMENT_PENDING_HEADING: 'Congrats!',
            IDT_SIGN_UP_SUCCESS_PAYMENT_PENDING_MESSAGE: 'You have successfully signed up with YipTV but we were unable to process payment on your credit card. Please click the button or link in the email we have just sent you to verify your account, then Sign In and update your credit card information.',
            IDT_SIGN_UP_SUCCESS_PAYMENT_PENDING_ACTIVE_HEADING: 'Congrats!',
            IDT_SIGN_UP_SUCCESS_PAYMENT_PENDING_ACTIVE_MESSAGE: 'You have successfully signed up with YipTV but we were unable to process payment on your credit card. Please <a class="underline-text" href="/sign-in">Sign In</a> and update your credit card information.',
