(function (app) {
    ...
    app.config(['$translateProvider', function ($translateProvider) {
        $translateProvider.translations('en', {
            ...
            SIGN_UP_SUCCESS_PAYMENT_FAILURE_MESSAGE: 'You have successfully signed up for YipTV Free Membership as we were unable to process payment on your credit card. You currently have access to limited number of channels. If you like to get become a YipTV premium member and get access to all the channels then click the button or link in the email we have just sent you to verify your account, then Log In, go to Accounts and click Upgrade to Premium Membership.',
            SIGN_UP_SUCCESS_PAYMENT_FAILURE_LOGIN_HEADING: 'Congrats!',
            SIGN_UP_SUCCESS_PAYMENT_FAILURE_LOGIN_MESSAGE: 'You have successfully signed up for YipTV Free Membership as we were unable to process payment on your credit card. You currently have access to limited number of channels. If you like to get become a YipTV premium member and get access to all the channels then <a class="underline-text" href="/sign-in”>Log In</a>, go to Accounts and click Upgrade to Premium Membership.',
