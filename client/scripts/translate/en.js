(function (app) {
    ...
    app.config(['$translateProvider', function ($translateProvider) {
        $translateProvider.translations('en', {
            ...
            BANNER_1_DESKTOP: '<a href="sign-up/paid"><img src="../images/banners/mobile/en/desktop-1.jpg" alt="beIN_MobilePort"></a>',
            BANNER_2_DESKTOP: '<a href="sign-up/paid"><img src="../images/banners/mobile/en/desktop-2.jpg" alt="beIN_MobilePort"></a>',
