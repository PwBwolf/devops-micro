...
var _ = require('lodash'),
    ...
    routes = [
        ...
        {path: '/api/get-channel', httpMethod: 'GET', middleware: [MediaCtrl.getChannel]},
        {path: '/api/get-channels', httpMethod: 'GET', middleware: [MediaCtrl.getChannels]},
        {path: '/api/get-channel-guide', httpMethod: 'GET', middleware: [MediaCtrl.getChannelGuide]},
        {path: '/api/get-user-channels', httpMethod: 'GET', middleware: [MediaCtrl.getUserChannels]},
        {path: '/api/get-promo-channels', httpMethod: 'GET', middleware: [MediaCtrl.getPromoChannels]},
        {
            path: '/*', httpMethod: 'GET',
